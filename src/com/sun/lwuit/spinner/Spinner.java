...
public class Spinner extends List {
    ...
    protected Dimension calcPreferredSize() {
        int boxWidth = getStyle().getFont().getHeight() + 2;
        ...
        return new Dimension(boxWidth + horizontalPadding, selectedHeight + verticalPadding);
    }
    ...
    public void keyReleased(int code) {
        ...
        if (game > 0) {
            ...
            if (getRenderer() instanceof DateTimeRenderer) {
                ...
                if (n.realValues) {
                    setValue(new Double(Double.parseDouble(t)));
                } else {
                    setValue(new Integer(Integer.parseInt(t)));
                }
            }
    ...
    public void paint(Graphics g) {
        ...
        if (System.currentTimeMillis() - inputSkipDelay < lastKeyInteraction || quickType.isPendingCommit()) {
            quickType.setSize(quickType.getPreferredSize());
